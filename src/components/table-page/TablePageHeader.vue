...
function hasTabCount(tab: HeaderTab) {
  return typeof tab.count === "number" && Number.isFinite(tab.count)
}

function formatTabCount(count: number | undefined) {
            ...
            <div class="relative min-w-0 flex-1 overflow-visible pt-1">
              ...
              >
                <nav class="relative flex min-w-max flex-nowrap items-center text-[14px]">
                  ...
                  >
                    <span class="relative isolate inline-flex items-center gap-1.5">
                      ...
                      <span
                        v-if="hasTabCount(tab)"
                        :class="[
                          'relative z-10 inline-flex min-w-5 items-center justify-center rounded-full px-1.5 py-0.5 text-[11px] font-medium leading-none tabular-nums transition-colors',
                          tab.active
