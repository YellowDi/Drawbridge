...
import { CalendarCellTrigger as RekaCalendarCellTrigger, CalendarRoot } from "reka-ui"
            ...
            >
              ...
              >
                <RekaCalendarCellTrigger
                  ...
                  as="button"
                  :class="cn(
                    'relative flex size-7 appearance-none items-center justify-center rounded-[9px] border-0 bg-transparent p-0 text-[11px] font-medium leading-none text-foreground outline-none shadow-none transition-colors',
