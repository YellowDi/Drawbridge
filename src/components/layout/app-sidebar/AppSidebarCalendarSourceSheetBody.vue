...
const barAccentClass: Record<AppSidebarCalendarItem["type"], string> = {
  deadline: "bg-orange-500 dark:bg-orange-400",
  release: "bg-blue-500 dark:bg-blue-400",
  maintenance: "bg-emerald-500 dark:bg-emerald-400",
}
      ...
      <template v-else>
        ...
        >
          <div class="mb-2 flex items-center gap-2 py-1">
            ...
            <span class="tabular-nums rounded-full bg-muted px-1.5 py-0.5 text-[10px] font-medium text-muted-foreground">
              {{ block.events.length }}
            </span>
          </div>
