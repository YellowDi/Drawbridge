...
<template>
  ...
  >
    ...
    <Input
      ...
      class="h-8 min-h-8 min-w-0 flex-1 border-0 bg-transparent py-0 pl-0 pr-2 text-sm leading-8 shadow-none focus-visible:border-transparent focus-visible:ring-0"
